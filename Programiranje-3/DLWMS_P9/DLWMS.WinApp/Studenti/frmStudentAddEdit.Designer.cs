namespace DLWMS.WinApp.Studenti
{
    partial class frmStudentAddEdit
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnGradAdd = new Button();
            btnDržavaAdd = new Button();
            ...
            // btnSacuvaj
            // 
            btnSacuvaj.BackColor = Color.Brown;
            btnSacuvaj.ForeColor = SystemColors.ButtonHighlight;
            btnSacuvaj.Location = new Point(473, 261);
            ...
            label2.Location = new Point(203, 244);
            label2.Name = "label2";
            ...
            // txtEmail
            // 
            txtEmail.Location = new Point(203, 262);
            ...
            cbAktivan.Location = new Point(381, 264);
            ...
            // btnGradAdd
            // 
            btnGradAdd.Location = new Point(378, 218);
            btnGradAdd.Name = "btnGradAdd";
            btnGradAdd.Size = new Size(170, 23);
            btnGradAdd.TabIndex = 21;
            btnGradAdd.Text = "Dodaj grad";
            btnGradAdd.UseVisualStyleBackColor = true;
            btnGradAdd.Click += btnGradAdd_Click;
            // 
            // btnDržavaAdd
            // 
            btnDržavaAdd.Location = new Point(203, 218);
            btnDržavaAdd.Name = "btnDržavaAdd";
            btnDržavaAdd.Size = new Size(170, 23);
            btnDržavaAdd.TabIndex = 22;
            btnDržavaAdd.Text = "Dodaj državu";
            btnDržavaAdd.UseVisualStyleBackColor = true;
            btnDržavaAdd.Click += btnDržavaAdd_Click;
            // 
            // frmStudentAddEdit
            // 
            ...
            Controls.Add(btnDržavaAdd);
            Controls.Add(btnGradAdd);
        ...
        private Button btnDržavaAdd;
        private Button btnGradAdd;
    }
}